...
debug_cmd="python $DLJC/dljc -t testminimizer --annotationClassPath $SECURITYPATH $debug_onlyCompile --expectOutputRegex 'Z3 Unsatisfiable' --checker $CHECKER --solver $SOLVER --solverArgs=\"collectStatistics=true\" -o logs -m INFER -afud $WORKING_DIR/annotated -- $build_cmd "
